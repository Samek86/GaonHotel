...
<div class="boardbg"><div class="boardform"><div class="blackboard"><div class="boardcontents">
	...
	<form name="guestInsert" action="G_guestEdit.do" class="guestin">
	...
	<table>
		...
		<tr>
			<td><textarea name=contents rows=9 cols=60 style="vertical-align: bottom;" placeholder="내용(1000자 미만)" required= ><%=bean.getContent() %></textarea></td>
		</tr>
		<tr>
			<td><input type=text name=pwd class="text" placeholder="비밀번호" required= ></td>
		</tr>
	</table>
	<%
