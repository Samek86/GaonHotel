...
public class AdminRoomDetailController extends HttpServlet {
	...
	protected void user(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("adminRoomDetail", dbsql.dbSelectDetail(Integer.parseInt(request.getParameter("roomID"))));
		HttpSession session = request.getSession();
		session.setAttribute("nowpage", "\".nowlogin\"");
		request.setAttribute("pageFile", "admin/adminRoomDetail.jsp");
